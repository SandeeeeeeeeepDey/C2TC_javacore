...
//lambda Expression is Used to define functional interface in a concise way. This feature is added in java 8.
...
//---------------------------------------------------------------------------------------------------------------------------
	// Driver class
	public class LambdaExpressionDemo{ // No need to use implements keyword
	public static void main(String[] args) {
		Conventional c=new Conventional();
		c.simpleText(); // We call the implementable class here in the driver main again.
		//-------------------------------------------------------------------------------------------------------------------
		 // Another simple method is: Using lambda Expression
		Time t= ()->{
			System.out.println("A Simple Text Output");
			};
			t.simpleText();
